...
- **Endpoint**：`POST https://app-diuy8vo6h9fl-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
async function queryMobileLocation(
  ...
  const url = new URL("https://app-diuy8vo6h9fl-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-diuy8vo6h9fl-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
