...
| Endpoint | `https://app-diuy8vo6h9fl-api-79jKP8yo70AL-gateway.appmiaoda.com/enterprise/patent/list` |
| HTTP Method | POST |
| Content-Type | `application/json;charset=UTF-8` |
| Auth 模式 | platform_managed |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| third_part_domain | `app-diuy8vo6h9fl-api-79jKP8yo70AL-gateway.appmiaoda.com` |
| 计费 | 启用（每次调用计费） |
...
async function fetchPatentList(
  ...
  const url = new URL(
    "https://app-diuy8vo6h9fl-api-79jKP8yo70AL-gateway.appmiaoda.com/enterprise/patent/list",
  );
