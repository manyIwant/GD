...
- **Endpoint**：`POST https://app-diuy8vo6h9fl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-diuy8vo6h9fl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
