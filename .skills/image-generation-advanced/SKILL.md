...
| 接口 | 方法 | Endpoint |
|------|------|----------|
| 提交任务 | POST | `https://app-diuy8vo6h9fl-api-ra5EZDjVKkXa-gateway.appmiaoda.com/image-generation/submit` |
| 查询状态 | POST/GET | `https://app-diuy8vo6h9fl-api-VaOwP2jDmAga-gateway.appmiaoda.com/image-generation/task` |
